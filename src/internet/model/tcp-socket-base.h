...
// Add Bayesian module (MATTEO)
  void AddBayes (Ptr<Bayes> bayes);
  void CheckBayes (void); 
...
// NEW FIELDS (MATTEO)
  Ptr<Bayes> m_bayes;//MATTEO
  uint32_t m_counter;//MATTEO
  // static uint32_t firstReceiveAck;//MATTEO
  // static uint32_t firstSendPacket;//MATTEO

  // static FILE* log_fileSDPacket;
  // static FILE* log_fileRCAck;
  ...
  static std::map<int , FILE *> FILE_DIC_SDPacket;
  static std::map<int , FILE *> FILE_DIC_RCPacket;
